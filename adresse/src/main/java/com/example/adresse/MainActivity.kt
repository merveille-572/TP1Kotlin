...
fun BusinessCard() {
    Column(
        ...
        Column(
            ...
            ContactItem(iconResId = R.drawable.message, contactText = "jennifer.doe@example.com")
            ContactItem(iconResId = R.drawable.phone, contactText = "+123 456 7890")
        }
    }
}

@Composable
fun ContactItem(iconResId: Int, contactText: String) {
    Row(
